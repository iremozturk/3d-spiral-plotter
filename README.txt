...
If you do any pre-processing on the data before it can be visualized please include that code and simple instructions for how to run it.
...
If you want to include support for non-uniform axis scales that would be cool and probably worth a few bonus points but 
it's not a requirement.

Let me (Arnold, jyu13@mail.sfsu.edu) know if you have any questions.
